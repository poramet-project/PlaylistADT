...
public class Playlist {
    ...
    // AF(songs) = เก็บเพลย์ลิสต์เพลง
    // song = รายกการเพลงที่ผู้ใช้เพิ่มเข้ามา
    ...
    // ประกาศ song เป็น final กันผู้ใช้เปลี่ยนค่า 
    ...
    public Playlist(List<String> initial) {
        ...
        this.songs = new ArrayList<String>(initial);
        checkRep();
    }
    ...
    public Playlist shuffled() {
        List<String> copy = new ArrayList<String>(songs);
